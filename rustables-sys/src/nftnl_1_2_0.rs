/* automatically generated by rust-bindgen 0.59.1 0.59.1 */

use core::option::Option;
use libc::{c_char, c_int, c_uint, c_ulong, c_void, nlmsghdr, FILE};
...
pub const NFTNL_PARSE_EBADINPUT: c_uint = 0;
pub const NFTNL_PARSE_EMISSINGNODE: c_uint = 1;
pub const NFTNL_PARSE_EBADTYPE: c_uint = 2;
pub const NFTNL_PARSE_EOPNOTSUPP: c_uint = 3;
...
pub const NFTNL_EXPR_NAME: c_uint = 0;
pub const NFTNL_EXPR_BASE: c_uint = 1;
...
pub const NFTNL_EXPR_PAYLOAD_DREG: c_uint = 1;
pub const NFTNL_EXPR_PAYLOAD_BASE: c_uint = 2;
pub const NFTNL_EXPR_PAYLOAD_OFFSET: c_uint = 3;
pub const NFTNL_EXPR_PAYLOAD_LEN: c_uint = 4;
pub const NFTNL_EXPR_PAYLOAD_SREG: c_uint = 5;
pub const NFTNL_EXPR_PAYLOAD_CSUM_TYPE: c_uint = 6;
pub const NFTNL_EXPR_PAYLOAD_CSUM_OFFSET: c_uint = 7;
pub const NFTNL_EXPR_PAYLOAD_FLAGS: c_uint = 8;

pub const NFTNL_EXPR_NG_DREG: c_uint = 1;
pub const NFTNL_EXPR_NG_MODULUS: c_uint = 2;
pub const NFTNL_EXPR_NG_TYPE: c_uint = 3;
pub const NFTNL_EXPR_NG_OFFSET: c_uint = 4;
pub const NFTNL_EXPR_NG_SET_NAME: c_uint = 5;
pub const NFTNL_EXPR_NG_SET_ID: c_uint = 6;

pub const NFTNL_EXPR_META_KEY: c_uint = 1;
pub const NFTNL_EXPR_META_DREG: c_uint = 2;
pub const NFTNL_EXPR_META_SREG: c_uint = 3;

pub const NFTNL_EXPR_RT_KEY: c_uint = 1;
pub const NFTNL_EXPR_RT_DREG: c_uint = 2;

pub const NFTNL_EXPR_SOCKET_KEY: c_uint = 1;
pub const NFTNL_EXPR_SOCKET_DREG: c_uint = 2;
pub const NFTNL_EXPR_SOCKET_LEVEL: c_uint = 3;

pub const NFTNL_EXPR_TUNNEL_KEY: c_uint = 1;
pub const NFTNL_EXPR_TUNNEL_DREG: c_uint = 2;

pub const NFTNL_EXPR_CMP_SREG: c_uint = 1;
pub const NFTNL_EXPR_CMP_OP: c_uint = 2;
pub const NFTNL_EXPR_CMP_DATA: c_uint = 3;

pub const NFTNL_EXPR_RANGE_SREG: c_uint = 1;
pub const NFTNL_EXPR_RANGE_OP: c_uint = 2;
pub const NFTNL_EXPR_RANGE_FROM_DATA: c_uint = 3;
pub const NFTNL_EXPR_RANGE_TO_DATA: c_uint = 4;

pub const NFTNL_EXPR_IMM_DREG: c_uint = 1;
pub const NFTNL_EXPR_IMM_DATA: c_uint = 2;
pub const NFTNL_EXPR_IMM_VERDICT: c_uint = 3;
pub const NFTNL_EXPR_IMM_CHAIN: c_uint = 4;
pub const NFTNL_EXPR_IMM_CHAIN_ID: c_uint = 5;

pub const NFTNL_EXPR_CTR_PACKETS: c_uint = 1;
pub const NFTNL_EXPR_CTR_BYTES: c_uint = 2;

pub const NFTNL_EXPR_CONNLIMIT_COUNT: c_uint = 1;
pub const NFTNL_EXPR_CONNLIMIT_FLAGS: c_uint = 2;

pub const NFTNL_EXPR_BITWISE_SREG: c_uint = 1;
pub const NFTNL_EXPR_BITWISE_DREG: c_uint = 2;
pub const NFTNL_EXPR_BITWISE_LEN: c_uint = 3;
pub const NFTNL_EXPR_BITWISE_MASK: c_uint = 4;
pub const NFTNL_EXPR_BITWISE_XOR: c_uint = 5;
pub const NFTNL_EXPR_BITWISE_OP: c_uint = 6;
pub const NFTNL_EXPR_BITWISE_DATA: c_uint = 7;

pub const NFTNL_EXPR_TG_NAME: c_uint = 1;
pub const NFTNL_EXPR_TG_REV: c_uint = 2;
pub const NFTNL_EXPR_TG_INFO: c_uint = 3;

pub const NFTNL_EXPR_MT_NAME: c_uint = 1;
pub const NFTNL_EXPR_MT_REV: c_uint = 2;
pub const NFTNL_EXPR_MT_INFO: c_uint = 3;

pub const NFTNL_EXPR_NAT_TYPE: c_uint = 1;
pub const NFTNL_EXPR_NAT_FAMILY: c_uint = 2;
pub const NFTNL_EXPR_NAT_REG_ADDR_MIN: c_uint = 3;
pub const NFTNL_EXPR_NAT_REG_ADDR_MAX: c_uint = 4;
pub const NFTNL_EXPR_NAT_REG_PROTO_MIN: c_uint = 5;
pub const NFTNL_EXPR_NAT_REG_PROTO_MAX: c_uint = 6;
pub const NFTNL_EXPR_NAT_FLAGS: c_uint = 7;

pub const NFTNL_EXPR_TPROXY_FAMILY: c_uint = 1;
pub const NFTNL_EXPR_TPROXY_REG_ADDR: c_uint = 2;
pub const NFTNL_EXPR_TPROXY_REG_PORT: c_uint = 3;

pub const NFTNL_EXPR_LOOKUP_SREG: c_uint = 1;
pub const NFTNL_EXPR_LOOKUP_DREG: c_uint = 2;
pub const NFTNL_EXPR_LOOKUP_SET: c_uint = 3;
pub const NFTNL_EXPR_LOOKUP_SET_ID: c_uint = 4;
pub const NFTNL_EXPR_LOOKUP_FLAGS: c_uint = 5;

pub const NFTNL_EXPR_DYNSET_SREG_KEY: c_uint = 1;
pub const NFTNL_EXPR_DYNSET_SREG_DATA: c_uint = 2;
pub const NFTNL_EXPR_DYNSET_OP: c_uint = 3;
pub const NFTNL_EXPR_DYNSET_TIMEOUT: c_uint = 4;
pub const NFTNL_EXPR_DYNSET_SET_NAME: c_uint = 5;
pub const NFTNL_EXPR_DYNSET_SET_ID: c_uint = 6;
pub const NFTNL_EXPR_DYNSET_EXPR: c_uint = 7;
pub const NFTNL_EXPR_DYNSET_EXPRESSIONS: c_uint = 8;
pub const NFTNL_EXPR_DYNSET_FLAGS: c_uint = 9;

pub const NFTNL_EXPR_LOG_PREFIX: c_uint = 1;
pub const NFTNL_EXPR_LOG_GROUP: c_uint = 2;
pub const NFTNL_EXPR_LOG_SNAPLEN: c_uint = 3;
pub const NFTNL_EXPR_LOG_QTHRESHOLD: c_uint = 4;
pub const NFTNL_EXPR_LOG_LEVEL: c_uint = 5;
pub const NFTNL_EXPR_LOG_FLAGS: c_uint = 6;

pub const NFTNL_EXPR_EXTHDR_DREG: c_uint = 1;
pub const NFTNL_EXPR_EXTHDR_TYPE: c_uint = 2;
pub const NFTNL_EXPR_EXTHDR_OFFSET: c_uint = 3;
pub const NFTNL_EXPR_EXTHDR_LEN: c_uint = 4;
pub const NFTNL_EXPR_EXTHDR_FLAGS: c_uint = 5;
pub const NFTNL_EXPR_EXTHDR_OP: c_uint = 6;
pub const NFTNL_EXPR_EXTHDR_SREG: c_uint = 7;

pub const NFTNL_EXPR_CT_DREG: c_uint = 1;
pub const NFTNL_EXPR_CT_KEY: c_uint = 2;
pub const NFTNL_EXPR_CT_DIR: c_uint = 3;
pub const NFTNL_EXPR_CT_SREG: c_uint = 4;

pub const NFTNL_EXPR_BYTEORDER_DREG: c_uint = 1;
pub const NFTNL_EXPR_BYTEORDER_SREG: c_uint = 2;
pub const NFTNL_EXPR_BYTEORDER_OP: c_uint = 3;
pub const NFTNL_EXPR_BYTEORDER_LEN: c_uint = 4;
pub const NFTNL_EXPR_BYTEORDER_SIZE: c_uint = 5;

pub const NFTNL_EXPR_LIMIT_RATE: c_uint = 1;
pub const NFTNL_EXPR_LIMIT_UNIT: c_uint = 2;
pub const NFTNL_EXPR_LIMIT_BURST: c_uint = 3;
pub const NFTNL_EXPR_LIMIT_TYPE: c_uint = 4;
pub const NFTNL_EXPR_LIMIT_FLAGS: c_uint = 5;

pub const NFTNL_EXPR_REJECT_TYPE: c_uint = 1;
pub const NFTNL_EXPR_REJECT_CODE: c_uint = 2;

pub const NFTNL_EXPR_QUEUE_NUM: c_uint = 1;
pub const NFTNL_EXPR_QUEUE_TOTAL: c_uint = 2;
pub const NFTNL_EXPR_QUEUE_FLAGS: c_uint = 3;
pub const NFTNL_EXPR_QUEUE_SREG_QNUM: c_uint = 4;

pub const NFTNL_EXPR_QUOTA_BYTES: c_uint = 1;
pub const NFTNL_EXPR_QUOTA_FLAGS: c_uint = 2;
pub const NFTNL_EXPR_QUOTA_CONSUMED: c_uint = 3;

pub const NFTNL_EXPR_MASQ_FLAGS: c_uint = 1;
pub const NFTNL_EXPR_MASQ_REG_PROTO_MIN: c_uint = 2;
pub const NFTNL_EXPR_MASQ_REG_PROTO_MAX: c_uint = 3;

pub const NFTNL_EXPR_REDIR_REG_PROTO_MIN: c_uint = 1;
pub const NFTNL_EXPR_REDIR_REG_PROTO_MAX: c_uint = 2;
pub const NFTNL_EXPR_REDIR_FLAGS: c_uint = 3;

pub const NFTNL_EXPR_DUP_SREG_ADDR: c_uint = 1;
pub const NFTNL_EXPR_DUP_SREG_DEV: c_uint = 2;

pub const NFTNL_EXPR_FLOW_TABLE_NAME: c_uint = 1;

pub const NFTNL_EXPR_FWD_SREG_DEV: c_uint = 1;
pub const NFTNL_EXPR_FWD_SREG_ADDR: c_uint = 2;
pub const NFTNL_EXPR_FWD_NFPROTO: c_uint = 3;

pub const NFTNL_EXPR_HASH_SREG: c_uint = 1;
pub const NFTNL_EXPR_HASH_DREG: c_uint = 2;
pub const NFTNL_EXPR_HASH_LEN: c_uint = 3;
pub const NFTNL_EXPR_HASH_MODULUS: c_uint = 4;
pub const NFTNL_EXPR_HASH_SEED: c_uint = 5;
pub const NFTNL_EXPR_HASH_OFFSET: c_uint = 6;
pub const NFTNL_EXPR_HASH_TYPE: c_uint = 7;
pub const NFTNL_EXPR_HASH_SET_NAME: c_uint = 8;
pub const NFTNL_EXPR_HASH_SET_ID: c_uint = 9;

pub const NFTNL_EXPR_FIB_DREG: c_uint = 1;
pub const NFTNL_EXPR_FIB_RESULT: c_uint = 2;
pub const NFTNL_EXPR_FIB_FLAGS: c_uint = 3;

pub const NFTNL_EXPR_OBJREF_IMM_TYPE: c_uint = 1;
pub const NFTNL_EXPR_OBJREF_IMM_NAME: c_uint = 2;
pub const NFTNL_EXPR_OBJREF_SET_SREG: c_uint = 3;
pub const NFTNL_EXPR_OBJREF_SET_NAME: c_uint = 4;
pub const NFTNL_EXPR_OBJREF_SET_ID: c_uint = 5;

pub const NFTNL_EXPR_OSF_DREG: c_uint = 1;
pub const NFTNL_EXPR_OSF_TTL: c_uint = 2;
pub const NFTNL_EXPR_OSF_FLAGS: c_uint = 3;

pub const NFTNL_EXPR_XFRM_DREG: c_uint = 1;
pub const NFTNL_EXPR_XFRM_SREG: c_uint = 2;
pub const NFTNL_EXPR_XFRM_KEY: c_uint = 3;
pub const NFTNL_EXPR_XFRM_DIR: c_uint = 4;
pub const NFTNL_EXPR_XFRM_SPNUM: c_uint = 5;

pub const NFTNL_EXPR_SYNPROXY_MSS: c_uint = 1;
pub const NFTNL_EXPR_SYNPROXY_WSCALE: c_uint = 2;
pub const NFTNL_EXPR_SYNPROXY_FLAGS: c_uint = 3;
...
pub const NFTNL_GEN_ID: c_uint = 0;
pub const __NFTNL_GEN_MAX: c_uint = 1;
...
pub const NFTNL_OBJ_TABLE: c_uint = 0;
pub const NFTNL_OBJ_NAME: c_uint = 1;
pub const NFTNL_OBJ_TYPE: c_uint = 2;
pub const NFTNL_OBJ_FAMILY: c_uint = 3;
pub const NFTNL_OBJ_USE: c_uint = 4;
pub const NFTNL_OBJ_HANDLE: c_uint = 5;
pub const NFTNL_OBJ_USERDATA: c_uint = 6;
pub const NFTNL_OBJ_BASE: c_uint = 16;
pub const __NFTNL_OBJ_MAX: c_uint = 17;

pub const NFTNL_OBJ_CTR_PKTS: c_uint = 16;
pub const NFTNL_OBJ_CTR_BYTES: c_uint = 17;

pub const NFTNL_OBJ_QUOTA_BYTES: c_uint = 16;
pub const NFTNL_OBJ_QUOTA_CONSUMED: c_uint = 17;
pub const NFTNL_OBJ_QUOTA_FLAGS: c_uint = 18;

pub const NFTNL_OBJ_CT_HELPER_NAME: c_uint = 16;
pub const NFTNL_OBJ_CT_HELPER_L3PROTO: c_uint = 17;
pub const NFTNL_OBJ_CT_HELPER_L4PROTO: c_uint = 18;
...
pub const NFTNL_OBJ_CT_TIMEOUT_L3PROTO: c_uint = 16;
pub const NFTNL_OBJ_CT_TIMEOUT_L4PROTO: c_uint = 17;
pub const NFTNL_OBJ_CT_TIMEOUT_ARRAY: c_uint = 18;

pub const NFTNL_OBJ_CT_EXPECT_L3PROTO: c_uint = 16;
pub const NFTNL_OBJ_CT_EXPECT_L4PROTO: c_uint = 17;
pub const NFTNL_OBJ_CT_EXPECT_DPORT: c_uint = 18;
pub const NFTNL_OBJ_CT_EXPECT_TIMEOUT: c_uint = 19;
pub const NFTNL_OBJ_CT_EXPECT_SIZE: c_uint = 20;

pub const NFTNL_OBJ_LIMIT_RATE: c_uint = 16;
pub const NFTNL_OBJ_LIMIT_UNIT: c_uint = 17;
pub const NFTNL_OBJ_LIMIT_BURST: c_uint = 18;
pub const NFTNL_OBJ_LIMIT_TYPE: c_uint = 19;
pub const NFTNL_OBJ_LIMIT_FLAGS: c_uint = 20;

pub const NFTNL_OBJ_SYNPROXY_MSS: c_uint = 16;
pub const NFTNL_OBJ_SYNPROXY_WSCALE: c_uint = 17;
pub const NFTNL_OBJ_SYNPROXY_FLAGS: c_uint = 18;

pub const NFTNL_OBJ_TUNNEL_ID: c_uint = 16;
pub const NFTNL_OBJ_TUNNEL_IPV4_SRC: c_uint = 17;
pub const NFTNL_OBJ_TUNNEL_IPV4_DST: c_uint = 18;
pub const NFTNL_OBJ_TUNNEL_IPV6_SRC: c_uint = 19;
pub const NFTNL_OBJ_TUNNEL_IPV6_DST: c_uint = 20;
pub const NFTNL_OBJ_TUNNEL_IPV6_FLOWLABEL: c_uint = 21;
pub const NFTNL_OBJ_TUNNEL_SPORT: c_uint = 22;
pub const NFTNL_OBJ_TUNNEL_DPORT: c_uint = 23;
pub const NFTNL_OBJ_TUNNEL_FLAGS: c_uint = 24;
pub const NFTNL_OBJ_TUNNEL_TOS: c_uint = 25;
pub const NFTNL_OBJ_TUNNEL_TTL: c_uint = 26;
pub const NFTNL_OBJ_TUNNEL_VXLAN_GBP: c_uint = 27;
pub const NFTNL_OBJ_TUNNEL_ERSPAN_VERSION: c_uint = 28;
pub const NFTNL_OBJ_TUNNEL_ERSPAN_V1_INDEX: c_uint = 29;
pub const NFTNL_OBJ_TUNNEL_ERSPAN_V2_HWID: c_uint = 30;
pub const NFTNL_OBJ_TUNNEL_ERSPAN_V2_DIR: c_uint = 31;

pub const NFTNL_OBJ_SECMARK_CTX: c_uint = 16;
...
pub const NFTNL_RULESET_TABLELIST: c_uint = 0;
pub const NFTNL_RULESET_CHAINLIST: c_uint = 1;
pub const NFTNL_RULESET_SETLIST: c_uint = 2;
pub const NFTNL_RULESET_RULELIST: c_uint = 3;
...
pub const NFTNL_RULESET_CTX_CMD: c_uint = 0;
pub const NFTNL_RULESET_CTX_TYPE: c_uint = 1;
pub const NFTNL_RULESET_CTX_TABLE: c_uint = 2;
pub const NFTNL_RULESET_CTX_CHAIN: c_uint = 3;
pub const NFTNL_RULESET_CTX_RULE: c_uint = 4;
pub const NFTNL_RULESET_CTX_SET: c_uint = 5;
pub const NFTNL_RULESET_CTX_DATA: c_uint = 6;
...
pub const NFTNL_SET_ELEM_FLAGS: c_uint = 0;
pub const NFTNL_SET_ELEM_KEY: c_uint = 1;
pub const NFTNL_SET_ELEM_VERDICT: c_uint = 2;
pub const NFTNL_SET_ELEM_CHAIN: c_uint = 3;
pub const NFTNL_SET_ELEM_DATA: c_uint = 4;
pub const NFTNL_SET_ELEM_TIMEOUT: c_uint = 5;
pub const NFTNL_SET_ELEM_EXPIRATION: c_uint = 6;
pub const NFTNL_SET_ELEM_USERDATA: c_uint = 7;
pub const NFTNL_SET_ELEM_EXPR: c_uint = 8;
pub const NFTNL_SET_ELEM_OBJREF: c_uint = 9;
pub const NFTNL_SET_ELEM_KEY_END: c_uint = 10;
pub const NFTNL_SET_ELEM_EXPRESSIONS: c_uint = 11;
pub const __NFTNL_SET_ELEM_MAX: c_uint = 12;
...
pub const NFTNL_UDATA_SET_TYPEOF_EXPR: c_uint = 0;
pub const NFTNL_UDATA_SET_TYPEOF_DATA: c_uint = 1;
pub const __NFTNL_UDATA_SET_TYPEOF_MAX: c_uint = 2;
